...
import com.example.shopingapp.models.binding.UserLoginBindingModel;
import com.example.shopingapp.models.binding.UserRegisterBindingModel;
...
public class UserController {
    ...
    @PostMapping("/login")
    public String loginConfirmed(@Valid UserLoginBindingModel userLoginBindingModel, BindingResult bindingResult, RedirectAttributes redirectAttributes, HttpSession httpSession){
